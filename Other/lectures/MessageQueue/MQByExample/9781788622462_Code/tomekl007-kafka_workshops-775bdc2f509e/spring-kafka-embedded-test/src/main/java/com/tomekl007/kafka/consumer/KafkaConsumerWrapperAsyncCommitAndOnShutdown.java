...
public class KafkaConsumerWrapperAsyncCommitAndOnShutdown implements KafkaConsumerWrapper {
    private static final Logger LOGGER = org.slf4j.LoggerFactory.getLogger(KafkaConsumerWrapperAsyncCommitAndOnShutdown.class);
    private KafkaConsumer<Integer, String> consumer;
    public List<ConsumerRecord<Integer, String>> consumedMessages = new LinkedList<>();

    public KafkaConsumerWrapperAsyncCommitAndOnShutdown(Map<String, Object> properties, String topic) {
